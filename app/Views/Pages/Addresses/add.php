...
<div class="container">
    ...
    <div class="page-header">
        <h3><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Enter a new delivery address.</h3>
    ...
    <div class="row">
        <div class="col-md-6">
            <form id="delivery-form" method="post" action="/addresses">
                ...
                <hr>
                <button type="submit" class="btn btn-danger btn-md">Continue to your order</button>
            </form>
        </div>
        <div class="col-md-6">
