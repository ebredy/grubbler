    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-online">
                            <img src="<?php echo $__assets->getUrl('/admin/global/portraits/2.jpg' );?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-off">
                            <img src="<?php echo $__assets->getUrl('/admin/global/portraits/3.jpg' );?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="<?php echo $__assets->getUrl('/admin/global/portraits/4.jpg' );?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-away">
                            <img src="<?php echo $__assets->getUrl('/admin/global/portraits/5.jpg' );?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
        ...
        <div class="navbar-brand navbar-brand-center">
          <a href="<?php echo $__assets->getUrl('index.html' );?>">
            <img class="navbar-brand-logo" src="<?php echo $__assets->getUrl('/img/grubbler-white.png' );?>" title="Remark"><span style="color: white; font-size: x-large;">-ADMIN</span>
          </a>
        </div>
      </div>
      <!-- End Navbar Collapse -->
